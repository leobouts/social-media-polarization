...
\noindent Finally we consider the batch version of the $ExpressedOpinion$ algorithm.\\ 
The $ExpressedOpinionBatch$, like the previous heuristics, does not recompute the opinion vector.
\\
\\
\begin{algorithm}[H]
