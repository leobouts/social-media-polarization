...
\begin{figure}[!htpb]
	...
	\begin{subfigure}{.43\textwidth}
		\centering
		\includegraphics[height=0.9\linewidth]{Figures/beefban Polarization Decrease}
		\caption{}
		\label{subfig:beefban_pol}
	\end{subfigure}
	\hfill
	\begin{subfigure}{.43\textwidth}
		\centering
		\includegraphics[height=0.9\linewidth]{Figures/beefban Polarization Decrease big}
		\caption{}
		\label{subfig:beefban_pol_big}
	\end{subfigure}
	\hfill
	\caption{Heuristic comparison of polarization in Beefban}
...
\begin{figure}[!htpb]
	...
	\begin{subfigure}{.43\textwidth}
		\centering
		\includegraphics[height=0.9\linewidth]{Figures/beefban Time Elapsed}
		\caption{}
		\label{subfig:beefban_time}
	\end{subfigure}
	\hfill
	\begin{subfigure}{.43\textwidth}
		\centering
		\includegraphics[height=0.9\linewidth]{Figures/beefban Time Elapsed big}
		\caption{}
		\label{subfig:beefban_time_big}
	\end{subfigure}
	\hfill
	\caption{Heuristic comparison of time in Beefban}
	\label{fig:beefban_timel}
\end{figure}
\clearpage
