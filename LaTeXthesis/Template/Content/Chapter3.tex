...
$E[\pi(z)]$ will be computed with the help of measures of similarity in combination of the expressed opinion. For example if two users have a large intersection the possibility that they will be friends is higher than two other users without mutual friends. Overlapping social circles increase the acceptance probability of a recommendation. Let $\Gamma(x)$ denote the number of neighbours of a node.
\\
\\
 \begin{itemize}
